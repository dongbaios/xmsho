...
- (void)popview:(UIView *)view{
    UIWindow *window = [[UIWindow alloc] initWithFrame:CGRectMake(0, 0,ScreenW, ScreenH)];
    window.backgroundColor = [UIColor colorWithRed:0/255.0f green:0/255.0f blue:0/255.0f alpha:0.6];
    window.hidden = NO;
